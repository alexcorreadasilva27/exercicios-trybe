...
[
    ...
    # Para invocar o método construtor, a sintaxe é NomeDaClasse
    # (parametro 1, parametro 2)
    # Repare que o parâmetro self foi pulado -- um detalhe do Python.
    # meu_user = User(
    # "Valentino Trocatapa", "valentino@tinytoons.com", "Grana")
    # meu_user.reset_password()
    # A variável `meu_user` contém o objeto criado pelo
    # construtor da classe User!
    # print(meu_user)
    # print(meu_user.name)
    # print(meu_user.email)
    # print(meu_user.password)
    # 1º Pilar POO: Abstração = Crie Entidades
    # 2º Pilar POO: Encapsulamento = Não preciso saber como funciona
]
