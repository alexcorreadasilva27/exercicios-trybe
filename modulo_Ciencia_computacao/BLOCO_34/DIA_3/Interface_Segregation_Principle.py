# """ ABC é uma Abstract Base Class. Herdar desta classe indica que estamos
# fazendo
...
# utilizamos o decorator `@abstractmethod`: se estes metodos não forem
# sobrescritas por
# uma implementação da classe herdeira, o Python nos avisará que estamos
# cometendo um erro."""
